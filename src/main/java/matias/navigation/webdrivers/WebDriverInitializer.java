package matias.navigation.webdrivers;
...
public class WebDriverInitializer {
    ...
    public static WebDriver getFirefoxDriver(){
        if(!firefoxDriverInitialized){
            File file = new File("/home/matias/Documents/Projects/mermaven/src/main/java/matias.navigation/webdrivers/geckodriver");
    ...
    public static WebDriver getDefaultWebDriver(){
        if(!chromeDriverInitialized){
            File file = new File("/home/matias/Documents/Projects/mermaven/src/main/java/matias.navigation/webdrivers/chromedriver");
